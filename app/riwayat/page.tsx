...
export default function RiwayatPage() {
  ...
  // Toggle status Sudah Dikembalikan / Belum Dikembalikan
    ...
    <div className="min-h-screen bg-pink-50 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto p-6 mt-10 bg-white rounded-xl shadow-md">
        ...
        {riwayat.length === 0 ? (
          ...
          <table className="w-full border border-pink-300 rounded-lg text-gray-800">
            ...
            <tbody>
              {riwayat.map((item, index) => (
                <tr key={index} className="hover:bg-pink-50 transition-all">
